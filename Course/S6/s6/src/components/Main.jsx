...
export const Main = () => {
  ...
  const [ingredients, setIngredients] = React.useState(["all the main spices", "pasta", "ground beef", "tomato paste"])//Previous array ["Chicken", "Oregano", "Tomatoes"]
...
//-----------Handling new ingredientes input without handleSubmit
  ...
  function toggleRecipeShown(){
    setRecipeShown(function(prevShown){
      return !prevShown;
    })
  }
